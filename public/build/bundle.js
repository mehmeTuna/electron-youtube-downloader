...
var app = (function () {
    ...
    /* src\components\SearchInput.svelte generated by Svelte v3.32.1 */
    const file = "src\\components\\SearchInput.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Arama yap";
    			add_location(input, file, 7, 2, 108);
    			add_location(button, file, 8, 2, 146);
    			add_location(main, file, 6, 0, 98);
    		},
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*searchData*/ ctx[0])) /*searchData*/ ctx[0].apply(this, arguments);
    						},
    						false,
    						false,
    						false
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, inputValue, $$value => $$invalidate(1, $inputValue = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("SearchInput", slots, []);
    	let { searchData } = $$props;
    	const writable_props = ["searchData"];
    	...
    	$$self.$capture_state = () => ({ inputValue, searchData, $inputValue });
    	...
    	return [searchData, $inputValue, input_input_handler];
    }

    class SearchInput extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { searchData: 0 });
    		...
    		if (/*searchData*/ ctx[0] === undefined && !("searchData" in props)) {
    			console.warn("<SearchInput> was created without expected prop 'searchData'");
    		}
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	searchinput = new SearchInput({
    			props: { searchData: /*searchData*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*$inputValue*/ 1) set_data_dev(t1, /*$inputValue*/ ctx[0]);
    		},
